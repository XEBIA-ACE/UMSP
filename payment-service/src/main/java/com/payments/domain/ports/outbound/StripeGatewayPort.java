...
/**
 * Outbound port (secondary port) for charging payments via the Stripe gateway.
 *
...
public interface StripeGatewayPort {
    ...
    /**
     * Submits a charge request to the Stripe payment gateway.
     *
    ...
    /**
     * Encapsulates the result of a Stripe charge attempt.
     *
     * @param transactionId the Stripe-assigned transaction / PaymentIntent id;
     *                      may be {@code null} on failure
     * @param success       {@code true} if the charge was accepted by Stripe
